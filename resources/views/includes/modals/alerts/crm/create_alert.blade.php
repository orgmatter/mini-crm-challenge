...
<div class="modal fade app-dashboard-modal" id="create_user_alert_modal_center" tabindex="-1" role="dialog" aria-labelledby="create-user-modal-center-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" id=""role="document">
        <div class="modal-content dashboard-modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="create-user-modal-center-title">Alert</h5>
